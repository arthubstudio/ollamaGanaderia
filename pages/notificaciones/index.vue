...
<template>
  <div class="max-w-4xl">
    <div class="flex items-center justify-between mb-8">
      ...
      <button class="px-4 py-2 bg-white border rounded-xl" @click="readAll">Marcar todas como leidas</button>
    </div>
    <div class="bg-white border border-gray-100 rounded-3xl overflow-hidden">
      <button v-for="item in items" :key="item.id" class="w-full text-left p-5 border-b flex gap-4 hover:bg-gray-50" @click="read(item)">
